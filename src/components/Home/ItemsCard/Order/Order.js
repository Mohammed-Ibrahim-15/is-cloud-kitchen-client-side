            ...
            <div className='my-6'>
                <div className="mt-6 hero max-h-max w-auto  bg-base-200 rounded-3xl">
                    <div className="hero-content flex-col lg:flex-row">
                        <img className="w-1/2 h-96 rounded-lg shadow-2xl" src="https://c8.alamy.com/comp/MRG1NT/delivery-man-courier-service-with-call-number-icon-vector-illustration-MRG1NT.jpg" />
                        <div>
                ...
                <div className="mt-6 hero max-h-max w-auto  bg-base-200 rounded-3xl">
                    <div className="hero-content flex-col lg:flex-row">
                        ...
                        <img className="w-1/2 h-96 rounded-lg shadow-2xl" src="http://d2g79oifq3rgie.cloudfront.net/wp-content/uploads/2021/12/27105933/Logo01.20221-600x600.png" />
                    </div>
                </div>
            </div>
        </div>
